...
function Hero({ sectionRef }) {
  return (
    ...
    >
      ...
      <div className="z-10 flex flex-col items-center flex-1 gap-4 text-center sm:gap-6 lg:items-start lg:text-left">
        ...
        <div className="flex flex-col flex-wrap justify-center w-full gap-3 mt-2 sm:flex-row lg:justify-start">
        ...
        <div className="flex items-center justify-center gap-3 mt-4 lg:justify-start sm:mt-6">
          ...
          <p className="text-xs font-medium sm:text-sm text-on-surface-variant">
      ...
      <div className="relative z-10 flex-1 w-full">
        ...
        <div className="absolute bottom-2 left-2 sm:bottom-4 sm:left-4 md:-bottom-6 md:-left-6 bg-white p-2 sm:p-4 md:p-6 rounded-lg sm:rounded-2xl shadow-xl border border-outline-variant max-w-[120px] sm:max-w-[240px] animate-bounce">
          <div className="flex items-center gap-1 mb-1 sm:gap-3 sm:mb-2">
            <div className="p-1 text-white rounded-md sm:p-2 sm:rounded-lg bg-tertiary-container">
              <span className="text-sm material-symbols-outlined sm:text-xl">
                trending_up
              </span>
            </div>
            <span className="text-[10px] font-bold sm:text-sm text-primary leading-tight">
              ROI Focused
            </span>
          </div>
          <p className="text-[9px] sm:text-xs text-on-surface-variant leading-snug">
